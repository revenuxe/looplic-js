...
const services = [
  { id: "screen-guard", label: "Screen Guard", shortLabel: "Guard", href: "/", icon: Shield, color: "from-blue-500 to-cyan-500", active: true },
  { id: "mobile-repair", label: "Mobile Repair", shortLabel: "Mobile", href: "/service/mobile-repair", icon: Smartphone, color: "from-orange-500 to-red-500", active: false },
...
export function HomepageServiceTabs({ currentAreaSlug }: { currentAreaSlug?: string }) {
  return (
